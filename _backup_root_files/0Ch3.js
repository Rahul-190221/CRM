...
async function run() {
  try {
    ...
    app.put(
      "/api/v1/admin/save-admin-section",
      async (req, res) => {
        try {
          const {
            userId,
    ...
    app.get(
      "/api/v1/admin/get-admin-section/:userId/:scheduleId",
      async (req, res) => {
        try {
    ...
    app.get(
      "/api/v1/admin/feedback-status/:userId/:scheduleId",
      async (req, res) => {
        try {
          const { userId, scheduleId } = req.params;
          if (!ObjectId.isValid(userId)) {
    ...
    app.put(
      "/api/v1/admin/users/:userId/schedules/:scheduleId/teacher",
      async (req, res) => {
        const { userId, scheduleId } = req.params;
    ...
    app.get(
      "/api/v1/admin/assigned-teachers/:userId/:scheduleId",
      async (req, res) => {
        const { userId, scheduleId } = req.params;
    ...
    app.put(
      "/api/v1/admin/bookings/:bookingId/teacher",
      async (req, res) => {
    ...
    app.get(
      "/api/v1/admin/trf-email-status/:userId/:scheduleId",
      async (req, res) => {
        try {
          const { userId, scheduleId } = req.params;
    ...
    app.post(
      "/api/v1/admin/send-trf-email/:userId/:scheduleId",
      upload.single("file"),
      async (req, res) => {
        try {
          const { userId, scheduleId } = req.params;
...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background:#ffffff;">
    ...
    app.get(
      "/api/v1/admin/bookings/by-schedule/:scheduleId",
      async (req, res, next) => {
        try {
    ...
    app.get(
      "/api/v1/admin/bookings/home-with-users",
      async (req, res) => {
        try {
    ...
    app.put(
      "/api/v1/user/bookings/:scheduleId",
      async (req, res) => {
        try {
  ...
  try {
    ...
    app.get(
      "/api/v1/admin/stats/users/mock-types/range",
      async (req, res, next) => {
        try {
    ...
    app.get(
      "/api/v1/admin/stats/users/mock-types/monthly",
      async (req, res, next) => {
        try {
          const { from, to, role = "user" } = req.query;
    ...
    app.get(
      "/api/v1/admin/stats/bookings/attendance",
      async (req, res) => {
        try {
    ...
    app.get(
      "/api/v1/admin/user-budget/:userId/:scheduleId",
      async (req, res) => {
        try {
          const { userId, scheduleId } = req.params;
    ...
    app.put(
      "/api/v1/user/update-multiple/:userId",
      async (req, res) => {
        const { userId } = req.params;
  ...
  `;
    ...
    app.post(
      "/api/v1/user/request-profile-edit",
      async (req, res) => {
        try {
    ...
    app.put(
      "/api/v1/user/approve-profile-edit/:userId",
      async (req, res) => {
        try {
          const { userId } = req.params;
          const {

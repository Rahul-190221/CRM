...
export default function Sidebar({ activePage, setActivePage }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: 'tasks', label: 'Lead Stage', icon: CheckSquare },
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-100 flex flex-col h-screen">
      ...
      <div className="p-4 border-t border-gray-100 space-y-2">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-white bg-red-500 hover:bg-red-600 transition-colors font-medium">

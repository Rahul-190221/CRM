    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-8 text-center border-b border-gray-100 bg-gradient-to-b from-yellow-50 to-white">
                    <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg border-2 border-yellow-300">
                        <img src={logo.src} alt="Luminedge Logo" className="w-12 h-12 object-contain drop-shadow-sm" />
                    </div>
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight mb-1">Luminedge</h1>

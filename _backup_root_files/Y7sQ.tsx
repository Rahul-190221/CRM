...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  console.log('API Base URL:', apiUrl)                           // ← Add this
  console.log('Fetching:', `${apiUrl}/api/auth/login`)           // ← Add this
  ...
  try {
    ...
    // Read raw text first – very useful for debugging
    const text = await response.text()
    console.log('Raw response body:', text.substring(0, 300))    // ← Add this

    let data
    try {
      data = JSON.parse(text)
    } catch (jsonErr) {
      console.error('JSON parse failed – raw body was HTML?', text.substring(0, 200))
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-8 text-center border-b border-gray-100">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Luminedge</h1>

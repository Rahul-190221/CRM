...
const SidebarAdmin = () => {
  ...
  const handleLinkClick = () => {
    // close sidebar on mobile after navigation (no UI change)
    setIsOpen(false);
  };

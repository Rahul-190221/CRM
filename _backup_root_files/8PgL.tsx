...
const SidebarAdmin = () => {
  ...
  return (
    <div className="flex">
      ...
      {/* Sidebar container */}
      <div
        className={`fixed top-0 left-0 h-screen w-64 bg-white p-0 sm:p-1 text-[#00000f] shadow-xl rounded-2xl md:bg-transparent transform ${
        ...
        <ul className="menu flex flex-col min-h-screen px-2 py-0 text-[#00000f] gap-0.5 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
          {[
            ...
            },
            {
              ...
              icon: <IoBagRemoveOutline className="h-5 w-5" />,
            },
            {
              href: "/admin/available-schedules",
              label: "Available Schedules",
              icon: <IoCloudDownloadOutline className="h-5 w-5" />,
            },
            {
              href: "/admin/homebased",
              label: "Home Based Booking",
              icon: <RiHomeOfficeFill className="h-5 w-5" />,
            },
            { href: "/admin/TRF", label: "TRF", icon: <IoMailOutline className="h-5 w-5" /> },
            {
              href: "/admin/homebasedtrf",
              label: "TRF Home Based",
              ...
              >
                ...
                {href === "/admin/profileedit" && pendingCount > 0 && (
                  <span
                    ...
                    aria-label={`${pendingCount} pending profile edit request${
                      pendingCount > 1 ? "s" : ""
                    }`}
                  >

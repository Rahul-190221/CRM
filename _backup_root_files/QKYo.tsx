...
export default function Signup({ onSignup, onSwitchToLogin }: SignupProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://crm-eta-blush.vercel.app/api'}/auth/register`, {
                method: 'POST',
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-primary-500 transition-all outline-none"
                                placeholder="John Doe"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="w-full pl-12 pr-4 py-3 bg-gray-50 border-none rounded-2xl text-sm focus:ring-2 focus:ring-primary-500 transition-all outline-none appearance-none"
                            >
                                <option value="agent">Agent (Default)</option>
                                <option value="bdm">BDM (Lead Manager)</option>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary-500 text-black py-4 mt-4 rounded-2xl font-black text-sm shadow-medium hover:shadow-large hover:bg-primary-600 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                    >
                ...
                <div className="p-8 pt-0 border-t border-gray-50 bg-gray-50/50 text-center">
                    <button
                        ...
                        className="text-gray-500 text-sm font-bold hover:text-gray-900 inline-flex items-center gap-2"
                    >

...
const CashMemoPage = () => {
  ...
  useEffect(() => {
    const generateMemoNumber = async () => {
      ...
      try {
        const { data } = await axios.get("https://server-io-psi.vercel.app/api/v1/admin/cash-memos/count");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await axios.post("https://server-io-psi.vercel.app/api/v1/admin/save-cash-memo", memoData, {
        headers: {
  ...
  <div className="mt-10">
    ...
    <div className="flex justify-between items-center mb-2">
      ...
      <a
        href={`https://server-io-psi.vercel.app/api/v1/admin/cash-memo/${memoData.memoNumber}/pdf`}
    ...
    <iframe
      ...
      src={`https://server-io-psi.vercel.app/api/v1/admin/cash-memo/${memoData.memoNumber}/pdf`}
